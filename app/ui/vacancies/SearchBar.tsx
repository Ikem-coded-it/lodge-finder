...
export default function SearchBar() {
  return (
    <section className="w-full flex justify-start items-center px-[30px] py-[20px] h-[81px]">
      <form className="flex items-center justify-start gap-[5px] h-fit w-fit">
        <div className="w-[528px] h-[41px] flex items-center justify-start px-[8px] gap-[8px] bg-[#F0F4F8]">
