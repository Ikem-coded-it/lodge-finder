...
export default function Hero() {
  return <header className="relative w-[90vw] min-h-[646px] max-h-[fit-content] mt-[100px] flex justify-center rounded-t-[30px] overflow-hidden">
    ...
    <div className="hidden lg:flex justify-center items-center w-[812px] h-[73px] py-[4px] pr-[24px] pl-[4px] bg-whiteBg-default gap-[20px] rounded-[50px] absolute bottom-[20px] left-0 right-0 my-0 mx-auto shadow-[0_0_10px_#555555]">
      {
        floaterData.map((data, index) => {
          return (
            <div key={data.title} className={clsx(
              ...
              {data.icon}
              <div className="flex flex-col items-start h-full gap-[10px]">
